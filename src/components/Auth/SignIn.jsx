                    ...
                    <div>
                         ...
                         <div className={'signIn-inputs-container'}>
                              {errors.email && touched.email ? (
                                   <p className={'signIn-input-error'}>{errors.email}</p>
                              ) : null}
                              <input
                         ...
                         <div className={'signIn-inputs-container'}>
                              {touched.password && errors.password ? (
                                   <p className={'signIn-input-error'}>{errors.password}</p>
                              ) : null}
                              <p className={'signIn-input-error'}>
                         ...
                         {captcha && (
                              <div className={'signIn-captcha-block'}>
                                   ...
                                   <div>
                                        <input
                                             className={'signIn-captcha-input'}
                                             placeholder={'enter symbols'}
                                             value={values.antiBotSymbols}
                                             onChange={handleChange}
                                             id={'antiBotSymbols'}
                                        />
                                   </div>
                         ...
                         <div className={'signIn-btn-container'}>
                              <button
                                   className={authError ? 'signIn-btn-error' : 'signIn-btn'}
                                   type={'submit'}
                                   disabled={loginFetch}
                              >
                                   {loginFetch ?
                                        <i className='fa fa-spinner fa-spin' /> : 'Log in'}
                              </button>
                              ...
                              {authError && <p className={'signIn-auth-error'}>{errorMessage}</p>}
                         </div>
                    </div>
               </div>
          </form>
